...
//<editor-fold defaultstate="collapsed" desc="ScrollMagic">
/* ScrollMagic v1.1.2 | (c) 2014 Jan Paepke (@janpaepke) | license & info: http://janpaepke.github.io/ScrollMagic */
!function(e, t) {
    "use strict";
    var r = function(r) {
        var s, a = "ScrollMagic", l = {container: t, vertical: !0, globalSceneOptions: {}, loglevel: 2, refreshInterval: 100}, c = this, u = e.extend({}, l, r), g = [], f = !1, h = 0, d = "PAUSED", p = !0, v = 0, m = !1, w = !0, E = function() {
            if (e.each(u, function(e) {
                l.hasOwnProperty(e) || delete u[e]
            }), u.container = e(u.container).first(), 0 === u.container.length)
                throw a + " init failed.";
        ...
        return this.addScene = function(t) {
            ...
            if (t instanceof n)
                t.parent() === c ? c.scrollTo(t.scrollOffset()) : log(2, "scrollTo(): The supplied scene does not belong to this controller. Scroll cancelled.", t);
                ...
                e.isFunction(t) ? y = t : y.call(u.container[0], t);
            return c
        }, this.scrollPos = function(t) {
            return arguments.length ? (e.isFunction(t) && (S = t), c) : S.call(c)
        }, this.info = function(e) {
            var t = {size: v, vertical: u.vertical, scrollPos: h, scrollDirection: d, container: u.container, isDocument: p};
        ...
        var o, a, l, c, u, g, f, h = {onCenter: .5, onEnter: 1, onLeave: 0}, d = "ScrollScene", p = {duration: 0, offset: 0, triggerElement: null, triggerHook: "onCenter", reverse: !0, tweenChanges: !1, loglevel: 2}, v = this, m = e.extend({}, p, n), w = "BEFORE", E = 0, S = {start: 0, end: 0}, y = 0, F = !0, b = {unknownOptionSupplied: function() {
                e.each(m, function(e) {
                ...
                if (e.isFunction(m.duration)) {
                    ...
                    m.duration = parseFloat(m.duration), (!e.isNumeric(m.duration) || m.duration < 0) && (m.duration = p.duration)
            }, offset: function() {
            ...
            if (a && m.triggerElement) {
                for (var n = e(m.triggerElement).first(), o = a.info(), s = i(o.container), l = o.vertical ? "top" : "left"; n.parent().data("ScrollMagicPinSpacer"); )
                    n = n.parent();
                var c = i(n);
            ...
            if (c && a) {
                var t = a.info();
                if (e || "DURING" !== w) {
                    var r = {position: u.inFlow ? "relative" : "absolute", top: 0, left: 0}, n = c.css("position") != r.position;
                    ...
                    o.top -= parseFloat(u.spacer.css("margin-top")), o[t.vertical ? "top" : "left"] += s, c.css({top: o.top, left: o.left})
                }
            }
        }, k = function() {
            if (c && a && u.inFlow) {
        ...
        return this.parent = function() {
            ...
            var r = "duration";
            return arguments.length ? (e.isFunction(t) || (o = void 0), R(r, t) && (v.trigger("change", {what: r, newval: m[r]}), v.trigger("shift", {reason: r})), v) : m[r]
        }, this.offset = function(e) {
            var t = "offset";
            return arguments.length ? (R(t, e) && (v.trigger("change", {what: t, newval: m[t]}), v.trigger("shift", {reason: t})), v) : m[t]
            ...
            var r = "triggerHook";
            return arguments.length ? (R(r, t) && (v.trigger("change", {what: r, newval: m[r]}), v.trigger("shift", {reason: r})), v) : e.isNumeric(m[r]) ? m[r] : h[m[r]]
            ...
            if (a)
                if (e)
                    if (a.enabled() && F) {
                        ...
                        t = m.duration > 0 ? (r - S.start) / (S.end - S.start) : r >= S.start ? 1 : 0, v.trigger("update", {startPos: S.start, endPos: S.end, scrollPos: r}), v.progress(t)
                    } else
                        c && "DURING" === w && x(!0);
                else
                    a.updateScene(v, !1);
            ...
            if (n = e.extend({}, i, n), r = e(r).first(), 0 === r.length)
                return v;
            ...
            var g = e("<div></div>").addClass(n.spacerClass).css(a).data("ScrollMagicPinSpacer", !0).css({position: o ? "relative" : "absolute", "margin-left": "auto", "margin-right": "auto", "box-sizing": "content-box"}), f = c[0].style;
            return u = {spacer: g, relSize: {width: "%" === l.width.slice(-1), height: "%" === l.height.slice(-1), autoFullWidth: "0px" === l.width && o && s(a.display)}, pushFollowers: n.pushFollowers, inFlow: o, origStyle: {width: f.width || "", position: f.position || "", top: f.top || "", left: f.left || "", bottom: f.bottom || "", right: f.right || "", "box-sizing": f["box-sizing"] || "", "-moz-box-sizing": f["-moz-box-sizing"] || "", "-webkit-box-sizing": f["-webkit-box-sizing"] || ""}, pinnedClass: n.pinnedClass}, u.relSize.width && g.css("width", l.width), u.relSize.height && g.css("height", l.height), c.before(g).appendTo(g).css({position: o ? "relative" : "absolute", top: "auto", left: "auto", bottom: "auto", right: "auto"}), (u.relSize.width || u.relSize.autoFullWidth) && c.css("box-sizing", "border-box"), e(t).on("scroll." + d + "_pin resize." + d + "_pin", O), c.on("mousewheel DOMMouseScroll", U), x(), v
    ...
    var i = function(t, r) {
        ...
        if (i)
            if (i.getBoundingClientRect) {
                ...
                n = t.offset() || n, r && (n.top -= e(document).scrollTop(), n.left -= e(document).scrollLeft());
        return n
    }, o = function(e) {
...
$(window).load(function() {
    ...
    //ScrollMagic
    // define params
    var duration = $("#slide1").height() + $(window).height();
    ...
    new ScrollScene({triggerElement: "#slide1"})
            .setTween(TweenMax.to("#slide1", 1, {backgroundPosition: bgPosMovement, ease: Linear.easeNone}))
            .addTo(controller);
    //.addIndicators({zindex: 1, suffix: "1"});

    new ScrollScene({triggerElement: "#slide2"})
            .setTween(TweenMax.to("#slide2", 1, {backgroundPosition: bgPosMovement, ease: Linear.easeNone}))
            .addTo(controller)
            ;// .addIndicators({zindex: 1, suffix: "2"});

    new ScrollScene({triggerElement: "#slide3"})
            .setTween(TweenMax.to("#slide3", 1, {backgroundPosition: bgPosMovement, ease: Linear.easeNone}))
            .addTo(controller)
            ;//.addIndicators({zindex: 1, suffix: "3"});

    new ScrollScene({triggerElement: "#slide4"})
            .setTween(TweenMax.to("#slide4", 1, {backgroundPosition: bgPosMovement, ease: Linear.easeNone}))
            .addTo(controller)
            ;//.addIndicators({zindex: 1, suffix: "4"});
    new ScrollScene({triggerElement: "#slide5"})
            .setTween(TweenMax.to("#slide5", 1, {backgroundPosition: bgPosMovement, ease: Linear.easeNone}))
            .addTo(controller)
            ;//.addIndicators({zindex: 1, suffix: "5"});
});
